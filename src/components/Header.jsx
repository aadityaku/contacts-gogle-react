        ...
        <AppBar position="sticky" sx={{backgroundColor:"white"}} elevation="1" >
            <Toolbar>
                ...
                <Typography variant="h6" color="black" sx={{marginLeft:1,fontSize:24,fontFamily:"sans-serif"}} >Contact</Typography>
                  ...
                  <Paper component="form" sx={{ p: '3px 10px',display:"flex",  alignItems: 'center', marginLeft:11, width: 690,borderRadius:2,}} >
                        
                    <IconButton type="submit" sx={{ p: '10px' }} aria-label="search">
                        <SearchIcon />
                    </IconButton>
                <InputBase onChange={(e) => handleSearch(e.target.value)} value={search} sx={{ ml: 1, flex: 1 }} placeholder="Search Google Contacts" inputProps={{ 'aria-label': 'search google maps' }}/>
